...
ALTER SEQUENCE public.games_opponent_goals_seq OWNED BY public.games.opponent_goals;
...
--
-- Name: games_winners_goals_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.games_winners_goals_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.games_winners_goals_seq OWNER TO freecodecamp;

--
-- Name: games_winners_goals_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.games_winners_goals_seq OWNED BY public.games.winner_goals;


--
-- Name: games_years_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.games_years_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.games_years_seq OWNER TO freecodecamp;

--
-- Name: games_years_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.games_years_seq OWNED BY public.games.year;
...
--
-- Name: games year; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games ALTER COLUMN year SET DEFAULT nextval('public.games_years_seq'::regclass);


--
-- Name: games winner_goals; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games ALTER COLUMN winner_goals SET DEFAULT nextval('public.games_winners_goals_seq'::regclass);


--
-- Name: games opponent_goals; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games ALTER COLUMN opponent_goals SET DEFAULT nextval('public.games_opponent_goals_seq'::regclass);
...
--
-- Name: games_winners_goals_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.games_winners_goals_seq', 1, false);


--
-- Name: games_years_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.games_years_seq', 1, false);
